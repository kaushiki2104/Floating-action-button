...
const IssueForm = () => {
  ...
  return (
    <form className="absolute bottom-20 p-4 rounded-md w-80 right-0 shadow-md flex flex-col gap-5 form_background">
      <h1 className="text-lg font-medium pt-2 pb-5  flex flex-wrap justify-center border-b-2 border-gray-800">
        Let us know about the <span className="font-semibold">issue</span> you
